...
# table. See https://open-meteo.com/en/docs for the full code list.
_CONDITION_BUCKETS = [
    (range(0, 1), "clear"),
    (range(1, 4), "cloudy"),
    (range(45, 49), "fog"),
...
class WeatherSensor(Sensor):
    ...
    def _fetch_once(self) -> dict:
        ...
        return {
            ...
            "outdoor_condition": _bucket_condition(int(current["weather_code"])),
        }
...
def _mock_reading() -> dict:
    return {
        ...
        "outdoor_condition": random.choice(["clear", "cloudy", "rain"]),
    }
